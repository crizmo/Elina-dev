module.exports = {
    ...
    description: "Help function for hug command with usage",
    execute(client, message, args, Discord){
        const user = message.mentions.users.first() || message.member.user
        const newEmbed = new Discord.MessageEmbed()

        .setColor('#FFDBE9')
        .setAuthor(`Hug Help`, user.displayAvatarURL())
        .setTitle('Hug command')
        .setURL('https://dsc.gg/elina')
        .setDescription('hug command with usage')
        .addFields(
        ...
        .setImage('http://www.simpleimageresizer.com/_uploads/photos/5a9b1d8c/image_2021-07-10_223814_75.png')
