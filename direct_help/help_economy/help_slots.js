module.exports = {
    ...
    description: "Help function for slots command with usage and info",
    execute(client, message, args, Discord){
        const user = message.mentions.users.first() || message.member.user
        const newEmbed = new Discord.MessageEmbed()

        .setColor('#FFDBE9')
        .setAuthor(`Slots Help`, user.displayAvatarURL())
        .setTitle('Slots command')
        .setURL('https://crizmo.github.io/elina/')
        .setDescription('Earnings method - gambling')
        .addFields(
            {name: 'Aliases: ', value: "slots"},
            {name: 'Usage: ', value: "=slots"},
            {name: 'Info: ', value: "You can use slots ever 60 seconds , If you win you get 10000 ¥ but if you lose your wallet amunt is deducted by 5000 ¥"},
        )
